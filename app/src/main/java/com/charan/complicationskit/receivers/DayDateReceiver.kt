...
import com.charan.complicationskit.complication.MonthProgressComplicationService
...
class DayDateReceiver : BroadcastReceiver(){
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if(intent.action  in Constants.TIME_CHANGE_INTENT_ACTIONS){
            ...
            ComplicationUtils.updateComplication(context, MonthProgressComplicationService::class.java)
        }
